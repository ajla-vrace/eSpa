        ...
        builder: (BuildContext context, BoxConstraints constraints) {
          return SingleChildScrollView(
            ...
            child: SizedBox(
              ...
              child: DataTable(
                columnSpacing:
                    constraints.maxWidth * 0.15, // Prostor između kolona
                ...
                rows: _zaposlenici.map((zaposlenik) {
                  return DataRow(
                    cells: [
                      ...
                      DataCell(Text(zaposlenik.korisnik?.korisnickoIme ?? "N/A")),
                      //DataCell(Text(novost.sadrzaj?.toString() ?? "N/A")),
                      
                      DataCell(Text(DateFormat('dd.MM.yyyy.')
                          .format(zaposlenik.datumZaposlenja ?? DateTime.now()))),
                          ...
                          children: [
                            IconButton(
                              ...
                              onPressed: () {
                                Navigator.push(
                                  ...
                                  MaterialPageRoute(
                                    builder: (context) =>
                                        ZaposlenikDetaljiPage(zaposlenik: zaposlenik),
                                  ),
                                );
                                ...
                                // Akcija za update
                                print('Update clicked for: ${zaposlenik.korisnikId}');
                              },
                            ),
                            /* IconButton(
                            ...
                            IconButton(
                              ...
                              onPressed: () async {
                                ...
                                if (confirm == true) {
                                  try {
                                    await _zaposlenikProvider.delete(zaposlenik.id!);
                                    setState(() {
                                      _zaposlenici.remove(
                                    ...
                                    ScaffoldMessenger.of(context).showSnackBar(
                                      const SnackBar(
                                          content:
                                              Text("Zaposlenik uspješno obrisana.")),
                                    );
                                  } catch (e) {
                                    ScaffoldMessenger.of(context).showSnackBar(
                                      const SnackBar(
                    ...
                    child: Row(
                        ...
                        Expanded(
                          child: TextField(
                            ...
                            decoration: const InputDecoration(
                              labelText: "Pretraži zaposlenike",
                      ...
                      child: const Text("Pretraži"),
                        ...
                        ElevatedButton(
                          ...
                          onPressed: () async {
                            try {
                              var data = await _zaposlenikProvider
