                        ...
                        children: [
                                        ...
                                        child: InkWell(
                                          onTap: () {
                                            Navigator.push(
                                              ...
                                              MaterialPageRoute(
                                                builder: (_) =>
                                                    UslugaDetailScreen(usluga: usluga),
                                              ),
                                            );
                                          },
                                          child: Column(
                                            ...
                                            children: [
                                              ClipRRect(
                                                ...
                                                child: usluga.slika != null && usluga.slika!.isNotEmpty
                                                    ? Image.memory(
                          ...
                          SizedBox(
                            ...
                            child: ListView.builder(
                             ...
                             itemCount: _zaposlenici != null ? _zaposlenici!.length : 0,
                              itemBuilder: (context, index) {
                                ...
                                return GestureDetector(
                                  onTap: () {
                                    Navigator.push(
                                      context,
                                      MaterialPageRoute(
                                        builder: (context) => ZaposlenikDetaljiScreen(
                                  ...
                                  child: Container(
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        ClipOval(
                                          child: (zaposlenik.slika?.slika != null &&
                                                  zaposlenik.slika!.slika!.isNotEmpty)
                                              ? Image.memory(
                                                  base64Decode(zaposlenik.slika!.slika!),
                                                  height: 80.0,
                                                  width: 80.0,
                                                  fit: BoxFit.cover,
                                                )
